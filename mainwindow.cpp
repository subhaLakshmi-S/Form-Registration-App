...
{
    QMessageBox::StandardButton reply=QMessageBox::question(this,"vimal 4176","Do you want to submit the form?",QMessageBox::Ok|QMessageBox::Cancel);
    if(reply==QMessageBox::Ok)
    {
        QMessageBox::information(this,"vimal 4176","Submitted successfully!");
    }
